...
/**
 * An activity representing a list of tutorAccounts. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link tutorAccountDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 */
public class tutorAccountListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutoraccount_list);
        ...
        if (findViewById(R.id.tutoraccount_detail_container) != null) {
        ...
        View recyclerView = findViewById(R.id.tutoraccount_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    mParentActivity.getSupportFragmentManager().beginTransaction()
                            .replace(R.id.tutoraccount_detail_container, fragment)
                            .commit();
                } else {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.tutoraccount_list_content, parent, false);
